...
import io.nekohasekai.sfa.update.UpdateChecker   // ← НОВОЕ
...
class SettingsFragment : Fragment() {
    ...
    private fun onCreate() {
        ...
        // Кнопку «Проверить обновления» всегда показываем (если надо — спрячете по флагу)
        binding.checkUpdateEnabled.isVisible = true
        binding.checkUpdateButton.isVisible = true
        ...
        binding.checkUpdateButton.setOnClickListener {
            UpdateChecker.checkNow(activity)        // ← НОВЫЙ вызов
        }
