...
class ConfigurationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // FAB → сразу ввод кода Denis Shield
        binding.fab.setOnClickListener {
            startActivity(
                Intent(requireContext(), NewProfileActivity::class.java)
                    .putExtra(NewProfileActivity.EXTRA_PROVISION_FLOW, true)
            )
        }
    ...
    class AddProfileDialog : BottomSheetDialogFragment(R.layout.sheet_add_profile) {
        ...
        override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            binding.createManually.setOnClickListener {
                ...
                startActivity(
                    Intent(requireContext(), NewProfileActivity::class.java)
                        .putExtra(NewProfileActivity.EXTRA_FORCE_ENTRY_MENU, true)
                )
            }
        }
    ...
    class Holder(private val adapter: Adapter, private val binding: ViewConfigutationItemBinding) :
        ...
        internal fun bind(profile: Profile) {
            ...
            binding.moreButton.setOnClickListener { button ->
                ...
                // УБИРАЕМ Share и Share URL — оставляем только Delete
                    ...
                    when (it.itemId) {
                        R.id.action_delete -> {
                            ...
                            adapter.scope.launch(Dispatchers.IO) {
                                runCatching { ProfileManager.delete(profile) }
                            }
                            true
                        }
                        else -> false
